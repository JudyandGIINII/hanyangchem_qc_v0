...
1. 수입검사성적서_Raw_Data.xlsx

2. QM301-7_RB 수입검사성적서.xlsx

3. 업체COA_염화칼슘_세계로비드_2025.04.23.pdf

4. 물먹는하마 내수8P 패키지_250213.pdf
...
QM301-7_RB 수입검사성적서.xlsx에는 38개 품목/공급업체 템플릿이 있다.
...
기존 수입검사성적서_Raw_Data.xlsx의 첫 시트 구조를 호환한다.
...
QM301-7_RB 수입검사성적서.xlsx의 38개 시트를 기준 프로파일 Draft로 Import한다.
...
아래 목록은 첨부 QM301-7_RB 수입검사성적서.xlsx에서 추출한 초기 Seed 후보이다. 원문 기준은 Import 후 품질팀 검토·승인을 거쳐야 하며, 시스템이 임의로 문구를 정정하지 않는다.
