...
import { MasterDataWorkspace } from "../master-data/MasterDataWorkspace";
import { StandardAliasWorkspace } from "../standard-aliases/StandardAliasWorkspace";

const stages = ["목록", "입고/LOT", "문서 검토", "매칭", "자체검사", "제출", "팀장 검토", "LOT 추적", "부적합", "보고서·통계", "마스터·별칭"] as const;
...
export function InspectionWorkspace({ publicDemo = PUBLIC_DEMO_MODE }: { publicDemo?: boolean }) {
  ...
  return <main className="workspace-shell">
    ...
    <section className="content-area">
      ...
      {active === "마스터·별칭" && <section className="stage-content" aria-labelledby="master-stage-title"><div className="section-heading"><div><p className="eyebrow">11 / MASTER DATA &amp; ALIASES</p><h2 id="master-stage-title">마스터 데이터·표준 항목 별칭</h2><p>품목·공급사·모델 마스터와 후보 추천 전용 별칭입니다.</p></div></div><MasterDataWorkspace publicDemo={publicDemo} /><StandardAliasWorkspace publicDemo={publicDemo} /></section>}
